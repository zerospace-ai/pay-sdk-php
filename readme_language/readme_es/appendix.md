...
Este documento proporciona las relaciones de mapeo de diccionario requeridas durante el desarrollo y la integración.

## 1. Lista de ChainID

| Nombre de Moneda | Nombre Completo | URL del Explorador de Blockchain | Chain ID |
| :--- | :--- | :--- | :--- |
...
## 2. Identificadores de Tipo de Token
...
| 2 | ETH Red USDT |
| 3 | TRON Red TRX |
| 4 | TRON Red Token: USDT |
| 5 | BNB Smart Chain Red BNB |
| 6 | BNB Smart Chain Red Token: USDT |
| 11 | Polygon Red Matic |
| 12 | Polygon Red Token: USDT |
| 13 | Polygon Red Token: USDC |
| 22 | BNB Smart Chain Red Token: USDC |
| 23 | BNB Smart Chain Red Token: DAI |
| 24 | ETH Red USDC |
| 25 | ETH Red DAI |
| 130 | Optimism Red ETH |
| 131 | Optimism Red Token: WLD |
| 132 | Optimism Red Token: USDT |
| 100 | BTC Red BTC Token de Red Principal |
| 200 | TON Red TON Token de Red Principal |

## 3. Información Básica del Contrato de Token

| Red Principal | Chain ID | Token ID | Dirección del Contrato (Token Address) | Symbol | Decimales (Decimals) |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
| | 1 | 1 | ETH (Moneda Nativa de Red Principal) | ETH | 18 |
...
| | 2 | 3 | TRX (Moneda Nativa de Red Principal) | TRX | 6 |
| | 2 | 4 | TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t | USDT | 6 |
| **Bitcoin** | 3 | 100 | BTC (Moneda Nativa de Red Principal) | BTC | 8 |
| | 3 | 102 | SATS | SATS | 18 |
| | 3 | 103 | RATS | RATS | 18 |
| | 3 | 101 | ORDI | ORDI | 18 |
...
| | 4 | 19 | SOL (Moneda Nativa de Red Principal) | SOL | 9 |
...
| | 56 | 5 | BNB (Moneda Nativa de Red Principal) | BNB | 18 |
