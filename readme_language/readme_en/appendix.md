...
This document provides the dictionary mapping relationships required during development and integration.

## 1. ChainID List

| Coin Name | Full Name | Blockchain Explorer URL | Chain ID |
| :--- | :--- | :--- | :--- |
...
| 2 | ETH Network USDT |
| 3 | TRON Network TRX |
| 4 | TRON Network Token: USDT |
| 5 | BNB Smart Chain Network BNB |
| 6 | BNB Smart Chain Network Token: USDT |
| 11 | Polygon Network Matic |
| 12 | Polygon Network Token: USDT |
| 13 | Polygon Network Token: USDC |
| 22 | BNB Smart Chain Network Token: USDC |
| 23 | BNB Smart Chain Network Token: DAI |
| 24 | ETH Network USDC |
| 25 | ETH Network DAI |
| 130 | Optimism Network ETH |
| 131 | Optimism Network Token: WLD |
| 132 | Optimism Network Token: USDT |
| 100 | BTC Network BTC Mainnet Token |
| 200 | TON Network TON Mainnet Token |

## 3. Token Contract Basic Information

| Mainnet Network | Chain ID | Token ID | Contract Address (Token Address) | Symbol | Decimals |
| :--- | :--- | :--- | :--- | :--- | :--- |
