...
このドキュメントでは、開発および統合中に必要となるディクショナリマッピング関係について説明します。

## 1. ChainID リスト

| コイン名 | フルネーム | ブロックチェーンエクスプローラーURL | Chain ID |
| :--- | :--- | :--- | :--- |
...
| 2 | ETH ネットワーク USDT |
| 3 | TRON ネットワーク TRX |
| 4 | TRON ネットワーク トークン: USDT |
| 5 | BNB Smart Chain ネットワーク BNB |
| 6 | BNB Smart Chain ネットワーク トークン: USDT |
| 11 | Polygon ネットワーク Matic |
| 12 | Polygon ネットワーク トークン: USDT |
| 13 | Polygon ネットワーク トークン: USDC |
| 22 | BNB Smart Chain ネットワーク トークン: USDC |
| 23 | BNB Smart Chain ネットワーク トークン: DAI |
| 24 | ETH ネットワーク USDC |
| 25 | ETH ネットワーク DAI |
| 130 | Optimism ネットワーク ETH |
| 131 | Optimism ネットワーク トークン: WLD |
| 132 | Optimism ネットワーク トークン: USDT |
| 100 | BTC ネットワーク BTC メインネットトークン |
| 200 | TON ネットワーク TON メインネットトークン |

## 3. トークンコントラクトの基本情報

| メインネットネットワーク | Chain ID | Token ID | コントラクトアドレス (Token Address) | Symbol | 小数点 (Decimals) |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
| | 2 | 3 | TRX (メインネットネイティブコイン) | TRX | 6 |
| | 2 | 4 | TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t | USDT | 6 |
| **Bitcoin** | 3 | 100 | BTC (メインネットネイティブコイン) | BTC | 8 |
| | 3 | 102 | SATS | SATS | 18 |
| | 3 | 103 | RATS | RATS | 18 |
| | 3 | 101 | ORDI | ORDI | 18 |
...
| | 56 | 5 | BNB (メインネットネイティブコイン) | BNB | 18 |
