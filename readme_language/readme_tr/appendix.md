...
Bu belge, geliştirme ve entegrasyon sırasında gereken sözlük eşleme ilişkilerini sağlar.

## 1. ChainID Listesi

| Coin Adı | Tam Adı | Blockchain Gezgini URL'si | Chain ID |
| :--- | :--- | :--- | :--- |
...
| 2 | ETH Ağı USDT |
| 3 | TRON Ağı TRX |
| 4 | TRON Ağı Token: USDT |
| 5 | BNB Smart Chain Ağı BNB |
| 6 | BNB Smart Chain Ağı Token: USDT |
| 11 | Polygon Ağı Matic |
| 12 | Polygon Ağı Token: USDT |
| 13 | Polygon Ağı Token: USDC |
| 22 | BNB Smart Chain Ağı Token: USDC |
| 23 | BNB Smart Chain Ağı Token: DAI |
| 24 | ETH Ağı USDC |
| 25 | ETH Ağı DAI |
| 130 | Optimism Ağı ETH |
| 131 | Optimism Ağı Token: WLD |
| 132 | Optimism Ağı Token: USDT |
| 100 | BTC Ağı BTC Ana Ağ Tokeni |
| 200 | TON Ağı TON Ana Ağ Tokeni |

## 3. Token Sözleşmesi Temel Bilgileri

| Ana Ağ (Mainnet) | Chain ID | Token ID | Sözleşme Adresi (Token Address) | Symbol | Ondalık (Decimals) |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
| | 1 | 1 | ETH (Ana Ağ Yerel Coin) | ETH | 18 |
...
| | 2 | 3 | TRX (Ana Ağ Yerel Coin) | TRX | 6 |
| | 2 | 4 | TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t | USDT | 6 |
| **Bitcoin** | 3 | 100 | BTC (Ana Ağ Yerel Coin) | BTC | 8 |
| | 3 | 102 | SATS | SATS | 18 |
| | 3 | 103 | RATS | RATS | 18 |
| | 3 | 101 | ORDI | ORDI | 18 |
...
| | 4 | 19 | SOL (Ana Ağ Yerel Coin) | SOL | 9 |
...
| | 56 | 5 | BNB (Ana Ağ Yerel Coin) | BNB | 18 |
