...
Dieses Dokument enthält die Verzeichniszuordnungsbeziehungen, die während der Entwicklung und Integration erforderlich sind.

## 1. ChainID-Liste

| Coin Name | Voller Name | Blockchain-Explorer-URL | Chain ID |
| :--- | :--- | :--- | :--- |
| eth | Ethereum | https://etherscan.io | 1 |
| trx | Tron | https://tronscan.io | 2 |
| btc | Bitcoin | https://blockchair.com/bitcoin | 3 |
| sol | Solana | https://explorer.solana.com | 4 |
| xrp | XRP | https://xrpscan.com | 5 |
| eth_optimism | Optimism | https://optimistic.etherscan.io | 10 |
| bnb | BNB Smart Chain | https://bscscan.com | 56 |
| matic_polygon | MATIC Polygon | https://polygonscan.com | 137 |
| TON | Toncoin | https://tonscan.org/ | 15186 |

## 2. Token-Typ-Identifikatoren

| TokenID | Beschreibung |
| :--- | :--- |
| 1 | ETH Netzwerk ETH |
| 2 | ETH Netzwerk USDT |
| 3 | TRON Netzwerk TRX |
| 4 | TRON Netzwerk Token: USDT |
| 5 | BNB Smart Chain Netzwerk BNB |
| 6 | BNB Smart Chain Netzwerk Token: USDT |
| 11 | Polygon Netzwerk Matic |
| 12 | Polygon Netzwerk Token: USDT |
| 13 | Polygon Netzwerk Token: USDC |
| 22 | BNB Smart Chain Netzwerk Token: USDC |
| 23 | BNB Smart Chain Netzwerk Token: DAI |
| 24 | ETH Netzwerk USDC |
| 25 | ETH Netzwerk DAI |
| 130 | Optimism Netzwerk ETH |
| 131 | Optimism Netzwerk Token: WLD |
| 132 | Optimism Netzwerk Token: USDT |
| 100 | BTC Netzwerk BTC Mainnet Token |
| 200 | TON Netzwerk TON Mainnet Token |

## 3. Grundlegende Informationen zum Token-Vertrag

| Mainnet Netzwerk | Chain ID | Token ID | Vertragsadresse (Token Address) | Symbol | Dezimalstellen (Decimals) |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
| | 1 | 1 | ETH (Mainnet Native Coin) | ETH | 18 |
...
| | 2 | 3 | TRX (Mainnet Native Coin) | TRX | 6 |
| | 2 | 4 | TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t | USDT | 6 |
| **Bitcoin** | 3 | 100 | BTC (Mainnet Native Coin) | BTC | 8 |
| | 3 | 102 | SATS | SATS | 18 |
| | 3 | 103 | RATS | RATS | 18 |
| | 3 | 101 | ORDI | ORDI | 18 |
...
| | 56 | 5 | BNB (Mainnet Native Coin) | BNB | 18 |
...
| | 15186| 200 | TON | TON | 9 |
| **Arbitrum** | 42161| 122 | 0xaf88d065e77c8cC2239327C5EDb3A432268e5831 | USDC | 6 |
...
| **Avax C** | 43114| 18 | 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E | USDC | 6 |
