...
이 문서에서는 개발 및 통합 중에 필요한 사전 매핑 관계를 제공합니다.

## 1. ChainID 목록

| 코인 이름 | 전체 이름 | 블록체인 탐색기 URL | Chain ID |
| :--- | :--- | :--- | :--- |
...
| 3 | TRON 네트워크 TRX |
| 4 | TRON 네트워크 토큰: USDT |
| 5 | BNB Smart Chain 네트워크 BNB |
| 6 | BNB Smart Chain 네트워크 토큰: USDT |
| 11 | Polygon 네트워크 Matic |
| 12 | Polygon 네트워크 토큰: USDT |
| 13 | Polygon 네트워크 토큰: USDC |
| 22 | BNB Smart Chain 네트워크 토큰: USDC |
| 23 | BNB Smart Chain 네트워크 토큰: DAI |
| 24 | ETH 네트워크 USDC |
| 25 | ETH 네트워크 DAI |
| 130 | Optimism 네트워크 ETH |
| 131 | Optimism 네트워크 토큰: WLD |
| 132 | Optimism 네트워크 토큰: USDT |
| 100 | BTC 네트워크 BTC 메인넷 토큰 |
| 200 | TON 네트워크 TON 메인넷 토큰 |

## 3. 토큰 컨트랙트 기본 정보

| 메인넷 네트워크 | Chain ID | Token ID | 컨트랙트 주소 (Token Address) | Symbol | 소수점 (Decimals) |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
| | 2 | 3 | TRX (메인넷 네이티브 코인) | TRX | 6 |
| | 2 | 4 | TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t | USDT | 6 |
| **Bitcoin** | 3 | 100 | BTC (메인넷 네이티브 코인) | BTC | 8 |
| | 3 | 102 | SATS | SATS | 18 |
| | 3 | 103 | RATS | RATS | 18 |
| | 3 | 101 | ORDI | ORDI | 18 |
