...
В этом документе представлены отношения сопоставления словарей, необходимые во время разработки и интеграции.

## 1. Список ChainID

| Название монеты | Полное название | URL-адрес обозревателя блокчейна | Chain ID |
| :--- | :--- | :--- | :--- |
...
| 2 | Сеть ETH USDT |
| 3 | Сеть TRON TRX |
| 4 | Сеть TRON Токен: USDT |
| 5 | Сеть BNB Smart Chain BNB |
| 6 | Сеть BNB Smart Chain Токен: USDT |
| 11 | Сеть Polygon Matic |
| 12 | Сеть Polygon Токен: USDT |
| 13 | Сеть Polygon Токен: USDC |
| 22 | Сеть BNB Smart Chain Токен: USDC |
| 23 | Сеть BNB Smart Chain Токен: DAI |
| 24 | Сеть ETH USDC |
| 25 | Сеть ETH DAI |
| 130 | Сеть Optimism ETH |
| 131 | Сеть Optimism Токен: WLD |
| 132 | Сеть Optimism Токен: USDT |
| 100 | Сеть BTC Токен основной сети BTC |
| 200 | Сеть TON Токен основной сети TON |

## 3. Основная информация о контракте токена

| Основная сеть | Chain ID | Token ID | Адрес контракта (Token Address) | Symbol | Десятичные знаки (Decimals) |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
| | 1 | 1 | ETH (Нативная монета основной сети) | ETH | 18 |
...
| | 2 | 3 | TRX (Нативная монета основной сети) | TRX | 6 |
| | 2 | 4 | TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t | USDT | 6 |
| **Bitcoin** | 3 | 100 | BTC (Нативная монета основной сети) | BTC | 8 |
| | 3 | 102 | SATS | SATS | 18 |
| | 3 | 103 | RATS | RATS | 18 |
| | 3 | 101 | ORDI | ORDI | 18 |
...
| | 4 | 19 | SOL (Нативная монета основной сети) | SOL | 9 |
...
| | 56 | 5 | BNB (Нативная монета основной сети) | BNB | 18 |
