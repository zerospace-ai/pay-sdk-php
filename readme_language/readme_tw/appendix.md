...
本文檔提供了開發和對接過程中需要的字典映射關係。

## 1. ChainID 列表

| 幣種名稱 | 全稱 | 區塊鏈瀏覽器地址 | Chain ID |
| :--- | :--- | :--- | :--- |
...
| 2 | ETH 網絡 USDT |
| 3 | TRON 網絡 TRX |
| 4 | TRON 網絡 Token: USDT |
| 5 | BNB Smart Chain 網絡 BNB |
| 6 | BNB Smart Chain 網絡 Token: USDT |
| 11 | Polygon 網絡 Matic |
| 12 | Polygon 網絡 Token: USDT |
| 13 | Polygon 網絡 Token: USDC |
| 22 | BNB Smart Chain 網絡 Token: USDC |
| 23 | BNB Smart Chain 網絡 Token: DAI |
| 24 | ETH 網絡 USDC |
| 25 | ETH 網絡 DAI |
| 130 | Optimism 網絡 ETH |
| 131 | Optimism 網絡 Token: WLD |
| 132 | Optimism 網絡 Token: USDT |
| 100 | BTC 網絡 BTC 主鏈 Token |
| 200 | TON 網絡 TON 主鏈 Token |

## 3. Token 合約基礎信息

| 主鏈網絡 | Chain ID | Token ID | 合約地址 (Token Address) | Symbol | 小數位 (Decimals) |
| :--- | :--- | :--- | :--- | :--- | :--- |
