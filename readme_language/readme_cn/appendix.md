...
| 2 | ETH 网络 USDT |
| 3 | TRON 网络 TRX |
| 4 | TRON 网络 Token: USDT |
| 5 | BNB Smart Chain 网络 BNB |
| 6 | BNB Smart Chain 网络 Token: USDT |
| 11 | Polygon 网络 Matic |
| 12 | Polygon 网络 Token: USDT |
| 13 | Polygon 网络 Token: USDC |
| 22 | BNB Smart Chain 网络 Token: USDC |
| 23 | BNB Smart Chain 网络 Token: DAI |
| 24 | ETH 网络 USDC |
| 25 | ETH 网络 DAI |
| 130 | Optimism 网络 ETH |
| 131 | Optimism 网络 Token: WLD |
| 132 | Optimism 网络 Token: USDT |
| 100 | BTC 网络 BTC 主链 Token |
| 200 | TON 网络 TON 主链 Token |

## 3. Token 合约基础信息

| 主链网络 | Chain ID | Token ID | 合约地址 (Token Address) | Symbol | 小数位 (Decimals) |
| :--- | :--- | :--- | :--- | :--- | :--- |
